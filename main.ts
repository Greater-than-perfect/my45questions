...
let personName1: string = "   Waqas ur rehman   \t\n";
...
let personName2: string = "waqas ur rehman";
...
let names: string[] = ["Tayyab", "Asif", "Waqas", "Abdul Rehman", "Haziq"];
...
let transportation: string[] = ["car", "bicycle", "motorcycle"];
transportation.forEach((vehicle: string) => 
...
let dinnerGuests : string []=["sajid", "Asif", "Siraj"];
...
let unableToAttend: string = dinnerGuests.shift()!;
...
let newGuest: string = "Muhammad Tayyab";
...
let placesToVisit: string[] = ["saudia arab", "turkey", "pakistan", "china", "dubai"];
...
placesToVisit.sort();
console.log(placesToVisit.join(", "));
placesToVisit.sort((a: string, b: string) => 
b.localeCompare(a));
console.log(placesToVisit.join(", "));
